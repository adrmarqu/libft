...
#    Updated: 2025/09/07 17:46:33 by adrmarqu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_alphanum.c ft_ascii.c ft_ato.c ft_strl.c ft_compare.c ft_search.c	\
	  ...
	  ft_join.c ft_output.c ft_length.c ft_itoa.c ft_split.c ft_transform.c	\
	  get_next_line.c fd_printf.c convert.c flags.c output.c parser.c		\
	  put_char.c put_nbr.c utils.c
